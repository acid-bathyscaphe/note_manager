note_dictionary = {'username' : input("Введите имя пользователя: "), 'title_list' : ['none'], 'content' : input("Введите описание заметки: "), 'status': input("Введите статус заметки: "), 'created_date': input("Введите дату создания заметки в формате день.месяц.год, например 10.11.2024: "), 'issue_date': input("Введите дату истечения заметки (дедлайн) в формате день.месяц.год, например 10.12.2024: ")}
...
note_dictionary['title_list'] = [title1, title2, title3]
print(note_dictionary['username'])
print(note_dictionary['title_list'])
